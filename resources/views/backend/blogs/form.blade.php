<div class="box-body">
    ...
    <div class="form-group">
        ...
        @if(!empty($blog->featured_image))
            <div class="col-lg-10">
                <img src="/storage/img/blog/{{ $blog->featured_image }}" height="90" style="float: left; margin-right: 6px;">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10 mce-box">
            {{ Form::textarea('content', null, ['class' => 'editor form-control', 'placeholder' => trans('validation.attributes.backend.blogs.content')]) }}
        </div><!--col-lg-10-->
    </div><!--form control-->
